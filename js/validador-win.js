(function(){ if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded', function(){ // WIN/HIN Validator (UE: 14 chars; US: 14 or 16). Ignore hyphen at pos 3 (between 2&3).
...
}); });} else { // WIN/HIN Validator (UE: 14 chars; US: 14 or 16). Ignore hyphen at pos 3 (between 2&3).
// Rules from Ricardo's spec.
const monthsMap = {
  A:'Janeiro', B:'Fevereiro', C:'Março', D:'Abril', E:'Maio', F:'Junho',
  G:'Julho', H:'Agosto', J:'Setembro', K:'Outubro', L:'Novembro', M:'Dezembro'
