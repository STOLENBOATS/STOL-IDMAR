...
(function(w,d){
  ...
  // 1) Polyfills mï¿½nimos usados nos validadores legados
  ...
  function alias(idNew, selExisting){
    if(d.getElementById(idNew)) return; // jï¿½ existe
  ...
  function ensureWinAliases(){
    ...
    // criar caixote de saï¿½da interpretativo se nï¿½o existir
  ...
  function ensureMotorAliases(){
    ...
    // Campos de pesquisa opcionais: cria se nï¿½o existirem (inputs *nï¿½o bloqueiam*)
  ...
  // 3) Extra: se o login da app usou outra key, aceitar NAV_SESSION tambï¿½m
  try{
