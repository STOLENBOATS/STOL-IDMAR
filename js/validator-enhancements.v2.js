...
(function(){
  ...
  function i18nForense(){
    ...
    const labelMap = {
      ...
      "Cord�es de solda": 'Cord�es de solda / <span class="en">Weld beads</span>',
      "Placa remarcada": 'Placa remarcada / <span class="en">Re-stamped plate</span>',
      "Camadas de tinta/abras�es": 'Camadas de tinta/abras�es / <span class="en">Paint layers/abrasions</span>',
      ...
      "Solda/corros�o an�mala": 'Solda/corros�o an�mala / <span class="en">Abnormal weld/corrosion</span>',
      "Remarca��o no bloco": 'Remarca��o no bloco / <span class="en">Re-mark on engine block</span>',
    };
