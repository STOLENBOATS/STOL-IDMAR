(function(w,d){function today(){const dt=new Date();const y=dt.getFullYear(),m=String(dt.getMonth()+1).padStart(2,'0'),da=String(dt.getDate()).padStart(2,'0');return `${y}-${m}-${da}`;}
function label(){return `IDMAR - POLÃÂCIA MARÃÂTIMA - ${w.IDMAR_VERSION||'Vs 1.3'} - ${today()}`;}
