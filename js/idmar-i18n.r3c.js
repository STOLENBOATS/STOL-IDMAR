// IDMAR i18n r3c � aplica tradu��es por data-i18n e data-i18n-ph
(function(w,d){
  const dict = {
    pt: {
      'title.validator':'IDMAR � Validador',
      'title.hwin':'IDMAR � Hist�rico WIN',
      'title.hmotor':'IDMAR � Hist�rico Motor',
      'h.validator':'Validador',
      'h.win':'Validador WIN',
      'h.motor':'Validador Motor',
      'h.hwin':'Hist�rico � WIN',
      'h.hmotor':'Hist�rico � Motores',
      'lbl.win':'WIN / HIN',
      'lbl.brand':'Marca',
      'btn.validateWin':'Validar WIN',
      'btn.validateMotor':'Validar Motor',
      'btn.exportCsv':'Exportar CSV',
      'btn.clearWin':'Limpar hist�rico (WIN)',
      'btn.clearMotor':'Limpar hist�rico (Motor)',
      'th.when':'Quando','th.state':'Estado','th.reason':'Justifica��o',
    ...
    es: {
      ...
      'th.when':'Cu�ndo','th.state':'Estado','th.reason':'Justificaci�n',
      'th.photo':'Foto (nombre)','th.thumb':'Miniatura',
      'th.sn':'S/N','th.brand':'Marca','th.model':'Modelo',
      'ph.search':'Buscar (WIN / texto)','ph.searchSn':'Buscar (S/N / marca)'
    },
    de: {
      'title.validator':'IDMAR � Pr�fer',
      'title.hwin':'IDMAR � WIN-Verlauf',
      'title.hmotor':'IDMAR � Motor-Verlauf',
      'h.validator':'Pr�fer',
      'h.win':'WIN Pr�fer',
      'h.motor':'Motor Pr�fer',
      'h.hwin':'Verlauf � WIN',
      'h.hmotor':'Verlauf � Motoren',
      'lbl.win':'WIN / HIN',
      'lbl.brand':'Marke',
      'btn.validateWin':'WIN pr�fen',
      'btn.validateMotor':'Motor pr�fen',
      'btn.exportCsv':'CSV exportieren',
      'btn.clearWin':'Verlauf l�schen (WIN)',
      'btn.clearMotor':'Verlauf l�schen (Motor)',
      'th.when':'Wann','th.state':'Status','th.reason':'Begr�ndung',
