...
(function(){
  ...
  const DICT = new Map(Object.entries({
    ...
    "Campo":"Field",
    "Valor":"Value",
    "Interpreta��o":"Meaning",
    "Validar WIN":"Validate WIN",
    "Validar Motor":"Validate Engine",
    "Selecionar":"Select",
    "Analisar":"Analyze",
    // --- Forense page ---
    "Forense � �ndice":"Forensics � Index",
    "Carregar evid�ncias":"Upload evidence",
    "Workspace":"Workspace",
    "Abrir lightbox":"Open lightbox",
    "Comparar":"Compare",
    "Anotar (rect)":"Annotate (rect)",
    "Limpar anota��es":"Clear annotations",
    ...
    "Cord�es de solda an�malos":"Abnormal weld beads",
    "Placa remarcada/substitu�da":"Re-marked/replaced plate",
    "Camadas de tinta/abras�es":"Paint layers/abrasions",
    ...
    "Solda/corros�o an�mala no boss (motor)":"Abnormal weld/corrosion at boss (engine)",
    "Remarca��o no bloco (motor)":"Re-stamping on block (engine)",
    "Notas":"Notes",
    ...
    // --- History ---
    "Hist�rico � WIN":"History � HIN/WIN",
    "Hist�rico � Motores":"History � Engines",
    "Estado (todos)":"State (all)",
    "V�lido":"Valid",
    "Inv�lido":"Invalid",
    "Exportar CSV":"Export CSV",
    "Limpar hist�rico (WIN)":"Clear history (HIN/WIN)",
    "Limpar hist�rico (Motor)":"Clear history (Engine)",
    "Quando":"When",
    "WIN/HIN":"HIN/WIN",
    "Estado":"State",
    "Justifica��o":"Reason",
  ...
  const PH_MAP = new Map(Object.entries({
    ...
    "De":"From",
    "At�":"To",
    "Observa��es t�cnicas�":"Technical notes�"
  }));
