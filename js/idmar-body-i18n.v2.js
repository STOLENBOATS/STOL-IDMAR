...
(function(){
  ...
  const DICT = new Map(Object.entries({
    ...
    "Campo":"Field",
    "Valor":"Value",
    "Interpretaï¿½ï¿½o":"Meaning",
    "Validar WIN":"Validate WIN",
    "Validar Motor":"Validate Engine",
    "Selecionar":"Select",
    "Analisar":"Analyze",
    // --- Forense page ---
    "Forense ï¿½ ï¿½ndice":"Forensics ï¿½ Index",
    "Carregar evidï¿½ncias":"Upload evidence",
    "Workspace":"Workspace",
    "Abrir lightbox":"Open lightbox",
    "Comparar":"Compare",
    "Anotar (rect)":"Annotate (rect)",
    "Limpar anotaï¿½ï¿½es":"Clear annotations",
    "Exportar PNG anotado":"Export annotated PNG",
    "Guardar ï¿½bundleï¿½ (JSON)":"Save bundle (JSON)",
    "Checklist forense":"Forensic checklist",
    "Rebites inconsistentes/adicionados":"Rivets inconsistent/added",
    "Cordï¿½es de solda anï¿½malos":"Abnormal weld beads",
    "Placa remarcada/substituï¿½da":"Re-marked/replaced plate",
    "Camadas de tinta/abrasï¿½es":"Paint layers/abrasions",
    ...
    "Solda/corrosï¿½o anï¿½mala no boss (motor)":"Abnormal weld/corrosion at boss (engine)",
    "Remarcaï¿½ï¿½o no bloco (motor)":"Re-stamping on block (engine)",
    "Notas":"Notes",
    "Contexto: WIN/HIN":"Context: HIN/WIN",
    "Contexto: Motor":"Context: Engine",
    "Larga a fotografia aqui ou clica para escolherï¿½":"Drop a photo here or click to selectï¿½",
    // --- History ---
    "Histï¿½rico ï¿½ WIN":"History ï¿½ HIN/WIN",
    "Histï¿½rico ï¿½ Motores":"History ï¿½ Engines",
    "Estado (todos)":"State (all)",
    "Vï¿½lido":"Valid",
    "Invï¿½lido":"Invalid",
    "Exportar CSV":"Export CSV",
    "Limpar histï¿½rico (WIN)":"Clear history (HIN/WIN)",
    "Limpar histï¿½rico (Motor)":"Clear history (Engine)",
    "Quando":"When",
    "WIN/HIN":"HIN/WIN",
    "Estado":"State",
    "Justificaï¿½ï¿½o":"Reason",
  ...
  const PH_MAP = new Map(Object.entries({
    ...
    "De":"From",
    "Atï¿½":"To",
    "Observaï¿½ï¿½es tï¿½cnicasï¿½":"Technical notesï¿½"
  }));
