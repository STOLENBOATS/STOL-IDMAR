(function (w, d) {
  ...
  function appendNotes(notes){
    ...
    // remove um bloco antigo para nï¿½o duplicar
  ...
  async function runSNCheck(){
    ...
    // drive-first: se ainda nï¿½o escolheram modelo/hp e houver apenas 1 hit
  ...
  d.addEventListener("DOMContentLoaded", () => {
    try {
      ...
      // ligar tambï¿½m ao botï¿½o "Validar Motor", se existir
      q("#btn-validate-engine")?.addEventListener("click", runSNCheck);
      console.info("[IDMAR] Engine SN glue ativo (hï¿½brido).");
    } catch(e){}
  });
