ï»¿(function(w,d){
  ...
  // ===== Motor: validaï¿½ï¿½o extra + notas (se possï¿½vel) =====
  try{
        ...
        try{
          ...
          if (w.IDMAR_EngineExtra && typeof w.IDMAR_EngineExtra.validateEngineExtra === "function"){
            ...
            if (extra && box){
              ...
              // Nota: nï¿½o forï¿½amos "NOK" visual para nï¿½o conflitar com a tua UI; apenas acrescentamos notas.
            }
          }
